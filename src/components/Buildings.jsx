...
function Buildings() {
  ...
  return (
    <div id="square" className="overflow-x-hidden overflow-y-scroll bg-white w-1/2 md:w-80 border-2 rounded-lg max-h-96 flex flex-col justify-center items-center" >
