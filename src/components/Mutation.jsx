...
``
  return (
    <div id="square-mutation" className="bg-white w-[11rem] md:w-80 border-2 flex justify-center rounded-lg h-96">
      <div id="square-mutation-children" className="md:ml-1 flex flex-col justify-center items-center w-full">
        {Object.entries(mutations).map(([mutationId, mutationData]) => (
          <div key={mutationId} className="w-[8rem] mt-1 p-1 h-auto flex items-center justify-center border-2 rounded-lg">
